<article class="my-16">
  <header class="relative">
    <div class="marginal-icon mb-2 sm:mb-0 sm:absolute grid place-items-center rounded-full bg-blue-200-10">
    ...
    <h1 class="my-2 text-2xl"><a class="dark:text-egg-200 text-blue-200" href="<?= $article->url() ?>"><?= $article->title()->html() ?></a></h1>
  </header>
  <div>
    <p class="my-4">
