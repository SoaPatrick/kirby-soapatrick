<?php if ($kirby->user()): ?>
  <a class="text-xs ml-2 inline-block h-3 w-3 after:content-none text-cyan-35 dark:text-cyan-62" href="<?= $page->panelUrl() ?>" target="_blank">
    <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-full h-full">
