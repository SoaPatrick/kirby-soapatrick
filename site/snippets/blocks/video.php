...
<figure class="video-block">
  <?php if ($video = video($block->url())): ?>
    <div
      ...
      data-src="<?= $block->url() ?>"
    >
      <button type="button" class="w-16" aria-label="Play Video"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><circle class="fill-primary" cx="256" cy="256" r="256"></circle><path class="fill-white" d="M371.91,244.63,198.36,144.43a13.69,13.69,0,0,0-20.54,11.86v200.4a13.69,13.69,0,0,0,20.54,11.86l173.55-100.2A13.69,13.69,0,0,0,371.91,244.63Z"></path></svg></button>
    </div>
  <?php else: ?>
