<header class="fixed bottom-8 left-8">
  <nav class="inline-flex flex-col items-start">
    <a class="mb-2 py-1" href="/">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 274.66 314.5" class="h-12 block text-primary hover:text-black dark:hover:text-white transition-all duration-300 ease-in-out">
    ...
    <?php endforeach ?>
    <button aria-label="toggle theme" class="nav-item" id="switchTheme"></button>
  </nav>
</header>